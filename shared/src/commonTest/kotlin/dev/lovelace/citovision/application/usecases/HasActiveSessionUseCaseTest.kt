...
class HasActiveSessionUseCaseTest {
    ...
    @Test
    fun `given an account user when checking then returns true`() = runTest {
        // Given
    ...
    @Test
    fun `given no account but persisted guest flag when checking then returns true`() = runTest {
        // Given
    ...
    @Test
    fun `given no session when checking then returns false`() = runTest {
        // Given
        every { authService.currentUser } returns flowOf(null)
